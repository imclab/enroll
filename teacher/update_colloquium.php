<?php
  ...
  if(strcmp($delete,'n') == 0){
    ...
    if(mysql_query("UPDATE colloquiums SET name='$name',description='$description',
      ...
      $result = "Error Code:001";
  }
  else{
    if(mysql_query("DELETE FROM colloquiums WHERE id=$mysql_id LIMIT 1"))
